...
// 传入generator函数  返回promise
function co(gen) {
  var ctx = this;   //获得当前上下文环境
 
  var args = slice.call(arguments, 1);    //获得多参数(如果有的话)
  ...
  return new Promise(function(resolve, reject) {
    ...
    function onFulfilled(res) {
      var ret;
      try {
        ret = gen.next(res);   //初始化启动一遍Generator next  得到指针
      } catch (e) {
        return reject(e);
